package com.ps.androidx.network.observer
...
class ConnectionObserver(val context: Context) : LiveData<Boolean>() {
    ...
    override fun onActive() {
        ...
        when {
            ...
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP -> setLollipopNetworkCallback()
            else -> {
    ...
    private fun setLollipopNetworkCallback() {
